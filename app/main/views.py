...
def index():
    ...
    title = 'Home - Welcome to Pitch Master'

    # Getting reviews by category
    motivational_piches = Pitch.get_pitches('motivational')
    business_piches = Pitch.get_pitches('business')
    entertainment_pitches = Pitch.get_pitches('entertainment')


    return render_template('index.html',title = title, motivational = motivational_piches, business = business_piches, entertainment = entertainment_pitches)
...
@main.route('/pitches/motivational_pitches')
def motivational_pitches():

    pitches = Pitch.get_pitches('motivational')

    return render_template("motivational_pitches.html", pitches = pitches)
